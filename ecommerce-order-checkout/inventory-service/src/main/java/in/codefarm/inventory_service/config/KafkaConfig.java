package in.codefarm.inventory_service.config;
 ...
 * Inventory Service publishes directly to Kafka.
 */
@Configuration
...
public class KafkaConfig {
    ...
    public ProducerFactory<String, String> transactionalProducerFactory() {
        ...
        configProps.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "inventory-service-transactional-id");
