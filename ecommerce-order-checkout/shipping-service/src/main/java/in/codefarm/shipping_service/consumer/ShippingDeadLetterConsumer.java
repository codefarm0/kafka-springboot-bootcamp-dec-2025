...
/**
 * Dead Letter Topic handler for Shipping Service.
 * Processes messages that failed after all retries or were marked as non-retryable.
 */
@Component
@Slf4j
public class ShippingDeadLetterConsumer {
    
    @KafkaListener(
        topics = "inventory-dlt",
        groupId = "shipping-service-dlt-group",
    ...
    public void handleDeadLetterMessage(
        ...
        log.error("=== DEAD LETTER MESSAGE RECEIVED (Shipping Service) ===");
